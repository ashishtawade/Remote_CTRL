...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button cmd = findViewById(R.id.button6);
...
//                        @Override
//                        public void run() {
//                            Toast.makeText(MainActivity5.this, "Connected to server", Toast.LENGTH_SHORT).show();
//                        }
//                    });
//                } catch (IOException e) {
//                    e.printStackTrace();
//                    Toast.makeText(MainActivity5.this, "Failed to connect to server", Toast.LENGTH_SHORT).show();
//                }
//            }
//        }).start();
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (socket != null && !socket.isClosed()) {
                    try {
                        socket.close();
                        Toast.makeText(MainActivity5.this, "Connection closed", Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
